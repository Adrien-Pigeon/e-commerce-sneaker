...
class PictureService
{
    ...
    {
        //La variable $params récupères les infos des parametres de services.yaml
        $this->params = $params;
    }
    ...
    public function add(UploadedFile $picture, ?string $folder = '', ?int $width = 250, ?int $height = 250)
    {
        ...
        switch ($imageWidth <=> $imageHeight) { //Triple comparaison (inférieure, égale, supérieure)
            case -1: //portrait
        ...
        //On déplace le fichier sur le path souhaité
