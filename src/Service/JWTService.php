...
class JWTService
{
    ...
    {
        if($validity > 0){
            // expiration est égale a la date NOW + le temps de validité du token
    ...
    // On vérifie que le token de l'utilisateur est valide (correctement formé)
