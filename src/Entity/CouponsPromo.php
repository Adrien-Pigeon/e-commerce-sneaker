...
use App\Repository\CouponsPromoRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: CouponsPromoRepository::class)]
class CouponsPromo
{

    use CreatedAtTrait; // UTILISE LE TRAIT "Created_at"
    ...
    #[ORM\ManyToOne(inversedBy: 'couponsPromos')]
    #[ORM\JoinColumn(nullable: false)]
    private ?CouponsTypes $coupons_types = null;

    #[ORM\OneToMany(mappedBy: 'couponsPromo', targetEntity: Orders::class)]
    ...
    public function removeOrder(Orders $order): self
    {
        if ($this->orders->removeElement($order)) {
            ...
            if ($order->getCouponsPromo() === $this) {
                $order->setCouponsPromo(null);
            }
        }
